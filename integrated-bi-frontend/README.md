# Integrated BI — Frontend

Interface web de la plateforme **Integrated BI** (Vue 3 + TypeScript), conçue dans le cadre du PFE 2026 pour SOTIFibre.

🌐 **Démo en production** : [sotifibre-frontend.onrender.com](https://sotifibre-frontend.onrender.com)
...
```env
VITE_API_URL=https://sotifibre-backend.onrender.com
```

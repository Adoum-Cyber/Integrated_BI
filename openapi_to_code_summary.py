"""
Convertit l'OpenAPI SOTIFibre en code_summary.yaml pour TestSprite.
...
SRC = Path(r"C:\PFE pour adoume\SOTIFibre Platform API (v1).yaml")
DST = Path(r"C:\PFE pour adoume\sotifibre_backend_django\testsprite_tests\tmp\code_summary.yaml")

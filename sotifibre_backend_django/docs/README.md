# 📊 Sotifibre BI Platform — Documentation backend

Bienvenue dans la documentation technique du backend Django de la plateforme **Integrated BI**.

Pour une présentation générale + démarrage rapide, voir le [`README.md`](../README.md) à la racine de `sotifibre_backend_django/`.
...
**Documentation API live** : [/api/docs/](https://sotifibre-backend.onrender.com/api/docs/) (Swagger UI) · [/api/redoc/](https://sotifibre-backend.onrender.com/api/redoc/) (ReDoc)
